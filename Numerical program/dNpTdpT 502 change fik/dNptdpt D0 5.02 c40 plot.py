...
recombD0 = openfile("dNptdpt_PbPb502_D0_c40   c.txt", (60, 6), 2)
aliceD0 = openfile("alice D0 502 40.txt",(22,4),1)
plot(aliceD0[0:18,0],aliceD0[0:18,1]/2,aliceD0[0:18,2],aliceD0[0:18,3],recombD0[:,:],'D0_5.02 30-50% y=-0.5~0.5')

#========================Jpsi========================

recombinJpsi = openfile("dNptdpt_PbPb502_Jpsi_c40   c.txt", (60, 6), 2)
aliceJpsi = openfile("alice Jpsi 502 30.txt", (6, 4), 1)
plot(aliceJpsi[:,0],aliceJpsi[:,1]/2,aliceJpsi[:,2],aliceJpsi[:,3],recombinJpsi[:,:],'J/psi_5.02 30-50% y=-0.9~0.9')

#=======================DS=============================
recombinDS = openfile("dNptdpt_PbPb502_Ds_c40   c.txt", (60, 6), 2)
aliceDS = openfile("alice Ds 502 40.txt", (9, 4), 1)
plot(aliceDS[0:7,0],aliceDS[0:7,1]/2,aliceDS[0:7,2],aliceDS[0:7,3],recombinDS[:,:],'Ds_5.02 30-50% y=-0.5~0.5')
