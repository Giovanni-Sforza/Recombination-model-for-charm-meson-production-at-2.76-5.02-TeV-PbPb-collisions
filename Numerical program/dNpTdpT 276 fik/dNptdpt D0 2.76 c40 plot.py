...
recombD0 = openfile("dNptdpt_PbPb276_D0_c40   c.txt", (60, 6), 2)
plot(ptaliceD0[0:7],xerrD0[0:7],y1D0[0:7],yerrD0[:,0:7],recombD0[3:60,:],'D0_2.76 30-50% y=-0.8~0.8')

#========================Jpsi========================

recombinJpsi = openfile("dNptdpt_PbPb276_Jpsi_c30   c.txt", (60, 6), 2)
...
recombinDS = openfile("dNptdpt_PbPb276_Ds_c35   c.txt", (60, 6), 2)
...
plot(aliceDS[:,0],aliceDS[:,1],aliceDS[:,2],aliceDS[:,3]/2,recombinDS[3:60,:],'Ds_2.76 30-40% y=-0.8~0.8')
