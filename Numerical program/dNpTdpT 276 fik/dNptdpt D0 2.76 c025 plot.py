...
recombD0 = openfile("dNptdpt_PbPb276_D0_c05   c.txt", (60, 6), 2)
aliceD0 = openfile("data_D0_276.dat",(9,2),1)
plot(aliceD0[0:7,0],xerrD0[0:7],aliceD0[0:7,1],y_errorD0[0:7],recombD0[3:60,:],'D0_276 0-10% y=-0.5~0.5')
...
recombinJpsi = openfile("dNptdpt_PbPb276_Jpsi_c10   c.txt", (60, 6), 2)
aliceJpsi = openfile("data_Jpsi_276 (1).dat", (13, 2), 1)
xerrJpsi = np.array([0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,2])/2
plot(aliceJpsi[:,0],xerrJpsi,aliceJpsi[:,1],y_errorJpsi,recombinJpsi[0:35,:],'J/psi_276 0-20% y=2.5~4')

#=======================DS=============================
xerrDs = np.array([1,1,2])
y_errorDS = np.array([0.00284,0.000281429,0.000021])/2/np.pi
recombinDS = openfile("dNptdpt_PbPb276_Ds_c05   c.txt", (60, 6), 2)
aliceDS = openfile("data_Ds_276.dat", (3, 2), 1)
plot(aliceDS[0:3,0],xerrDs,aliceDS[0:3,1],y_errorDS,recombinDS[3:60,:],'Ds_276 0-10% y=-0.5~0.5')
