...
dataDS1 = np.sqrt(dataDS1/2)
dataD01 = np.sqrt(dataD01/5)


dataDS2 = openfile("err of dNptdpt_PbPb276_Ds_c025 fore.txt", (30,30))
dataD02 = openfile("err of dNptdpt_PbPb276_D0_c025 fore.txt", (30,30))
dataJpsi2 = openfile("err of dNptdpt_PbPb276_Jpsi_c025 fore.txt",(29,30))

dataDS2 = np.sqrt(dataDS2/3)
...
for i in range(30):
    for j in range(30):
        dataerr =np.reshape(dataerr2[:,j],(30))+ np.reshape(dataerr1[:,i],(30))
...
print("err of DS 30 = ",dataDS1[TCi,CCi1])
print("err of DS 025 = ",dataDS2[TCi,CCi2])
print("err of D0 30 = ",dataD01[TCi,CCi1])
print("err of D0 025 = ",dataD02[TCi,CCi2])
